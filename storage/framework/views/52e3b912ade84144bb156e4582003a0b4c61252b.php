                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <button class="btn btn-sm btn-flat btn-warning"><a href="/potensidesa/edit/<?php echo e($d->id); ?>" ><i class="fa fa-edit"></i></a></button>
                          <button class="btn btn-sm btn-flat btn-danger"><a href="/potensidesa/delete/<?php echo e($d->id); ?>" ><i class="fa fa-trash"></i></a></button>
                      </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tubesSIG\resources\views/admin/potensiDesa/index.blade.php ENDPATH**/ ?>