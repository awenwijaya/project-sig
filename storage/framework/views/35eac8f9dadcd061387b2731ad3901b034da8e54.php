...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group">
                        ...
                        <input name="koordinat" id="koordinat" type="text" class="form-control" placeholder="Koordinat" value="<?php echo e($sekolah->koordinat); ?>">
                        <div class="text-danger">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class = "col-sm-4">
                      ...
                      var curKoordinat = [<?= $sekolah->koordinat ?>];
